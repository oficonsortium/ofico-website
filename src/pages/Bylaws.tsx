        ...
        <div className="space-y-8 text-gray-700">
          <section id="summary">
            ...
            <ul className="list-disc pl-6 space-y-3 mb-8">
              <li><Link to="governance" smooth={true} className="text-blue-600 hover:underline cursor-pointer"><strong>Governance & Membership Structure</strong>: The General Assembly, composed of Community and Supporting Members, holds exclusive voting rights, including electing and removing directors, amending bylaws, and overseeing financial transparency standards</Link></li>
              <li><Link to="board" smooth={true} className="text-blue-600 hover:underline cursor-pointer"><strong>Board Structure & Elections</strong>: The board consists of 3 to 15 directors elected by the General Assembly for staggered three-year terms, with committees like the Nomination and Executive Committees supporting governance and operations</Link></li>
              <li><Link to="roles" smooth={true} className="text-blue-600 hover:underline cursor-pointer"><strong>Roles & Responsibilities</strong>: Officers include the President, Secretary, Treasurer, and Executive Director, who acts as the chief executive, overseeing strategy, operations, and compliance under board supervision</Link></li>
              <li><Link to="meetings" smooth={true} className="text-blue-600 hover:underline cursor-pointer"><strong>Meetings & Decision-Making</strong>: The board and General Assembly meet regularly, with provisions for remote participation, quorum requirements, and written consents for decision-making</Link></li>
              <li><Link to="financial" smooth={true} className="text-blue-600 hover:underline cursor-pointer"><strong>Financial & Legal Matters</strong>: The bylaws outline membership dues, financial oversight, indemnification policies, and conflict-of-interest provisions to ensure ethical and legal compliance</Link></li>
            </ul>
          </section>
